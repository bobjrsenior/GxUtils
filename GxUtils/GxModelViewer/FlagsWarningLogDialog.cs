...
namespace GxModelViewer
{
    ...
    /// </summary>
    public partial class FlagsWarningLogDialog : Form
    {
        public FlagsWarningLogDialog(List<string> warningLog)
        {
            if (warningLog == null)
        ...
        public FlagsWarningLogDialog(List<string> warningLog, string title, string description)
        {
            if (warningLog == null)
                throw new ArgumentNullException("warningLog");
            ...
            InitializeComponent();
            this.Text = title;
            this.lblInfoText.Text = description;
